...
public class BootanimationActivity extends AppCompatActivity implements
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            new AlertDialog.Builder(BootanimationActivity.this).setTitle("Error").setMessage(e.getMessage()).setPositiveButton("OK", null).show();
                        }
                    }
                });
